# """
# evaluate_nfa_v2_llama_nocot.py
# ===================
# Evaluates base or LoRA fine-tuned Llama-3.1-8B-Instruct on 5-tier NFA v2 dataset.
...
# Usage:
#   # Baseline:
#   python3 evaluate_nfa_v2_llama_nocot.py \
#       --model_path /home/shovik.roy/.cache/huggingface/hub/models--meta-llama--Llama-3.1-8B-Instruct/snapshots/0e9e39f249a16976918f6564b8830bc894c89659 \
#       --data_file  nfa_v2_nocot_test.jsonl \
#       --mode       baseline \
#       --out        eval_results/results_baseline_iid_llama3.1_8b.json

#   # No-CoT fine-tuned:
#   python3 evaluate_nfa_v2_llama_nocot.py \
#       --model_path /home/shovik.roy/.cache/huggingface/hub/models--meta-llama--Llama-3.1-8B-Instruct/snapshots/0e9e39f249a16976918f6564b8830bc894c89659 \
#       --lora_path  lora_output_nfa_v2_nocot_llama3.1_8b \
#       --data_file  nfa_v2_nocot_test.jsonl \
#       --mode       nocot \
#       --out        eval_results/results_nocot_iid_llama3.1_8b.json
# """
...
#                     default="/home/shovik.roy/.cache/huggingface/hub/models--meta-llama--Llama-3.1-8B-Instruct/snapshots/0e9e39f249a16976918f6564b8830bc894c89659")
...
#     ap.add_argument("--out",            default="eval_results/results_llama3.1_8b.json")
#     args = ap.parse_args()
#     evaluate(args)
