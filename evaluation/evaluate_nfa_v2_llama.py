...
Usage:
  # Baseline:
  python3 evaluate_nfa_v2_llama.py \
      ...
      --mode       baseline \
      --out        eval_results/results_baseline_llama3.1_8b.json

  # CoT fine-tuned:
  python3 evaluate_nfa_v2_llama.py \
      --model_path [FILE_PATH]/models--meta-llama--Llama-3.1-8B-Instruct/snapshots/0e9e39f249a16976918f6564b8830bc894c89659 \
      --lora_path  lora_output_nfa_v2_cot_llama3.1_8b \
      --data_file  nfa_v2_cot_test.jsonl \
      --mode       cot \
      --out        eval_results/results_cot_llama3.1_8b.json
  ...
  python3 evaluate_nfa_v2_llama.py \
      ...
      --data_file  nfa_v2_nocot_test.jsonl \
      --mode       nocot \
      --out        eval_results/results_nocot_llama3.1_8b.json
"""
