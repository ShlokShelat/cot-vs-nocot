"""
Fine-tuning script — NFA v2 No-CoT dataset (5-tier)
...
TRAIN_FILE = "nfa_v2_nocot_train.jsonl"
VAL_FILE   = "nfa_v2_nocot_val.jsonl"

OUTPUT_DIR   = "lora_output_nfa_v2_nocot_[model_tag]"
DATASET_MODE = "nfa_v2_nocot"
...
print("=" * 80)
print(f"Mode: NFA-V2-NOCOT | Seed: {SEED} | GPU: {torch.cuda.get_device_name(0)}")
