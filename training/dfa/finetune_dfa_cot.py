...
finetune_script.py
====================
Fine-tuning script -- DFA dataset (Chain-of-Thought condition)
Model   : [MODEL]-7B-Instruct (change MODEL_PATH for smaller variants)
Dataset : dfa_cot_train.jsonl / dfa_cot_val.jsonl
Format  : ChatML messages (role/content pairs)
Output  : lora_output_dfa_cot/
...
TRAIN_FILE   = "dfa_cot_train.jsonl"
VAL_FILE     = "dfa_cot_val.jsonl"
OUTPUT_DIR   = "lora_output_dfa_cot"
DATASET_MODE = "dfa_cot"
...
print("=" * 80)
print(f"Mode: DFA-COT | Seed: {SEED} | GPU: {torch.cuda.get_device_name(0)}")
