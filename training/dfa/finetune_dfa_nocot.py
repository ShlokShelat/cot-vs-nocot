...
finetune_nocot.py
=====================
Fine-tuning script -- DFA dataset (No-CoT condition)
Model   : [MODEL]-7B-Instruct (change MODEL_PATH for smaller variants)
Dataset : dfa_nocot_train.jsonl / dfa_nocot_val.jsonl
Format  : ChatML messages (role/content pairs)
Output  : lora_output_dfa_nocot/
...
MODEL_PATH   = "/path/to/models/[MODEL]-7B-Instruct"
TRAIN_FILE   = "dfa_nocot_train.jsonl"
VAL_FILE     = "dfa_nocot_val.jsonl"
OUTPUT_DIR   = "lora_output_dfa_nocot"
DATASET_MODE = "dfa_nocot"
...
print("=" * 80)
print(f"Mode: DFA-NOCOT | Seed: {SEED} | GPU: {torch.cuda.get_device_name(0)}")
